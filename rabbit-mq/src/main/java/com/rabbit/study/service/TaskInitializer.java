...
public class TaskInitializer {
    ...
    public static final String SERVICE_ID = generateRandomID();
    ...
    public void generateTask() {
        if (redisLock.acquireLock(ONE_MIN_IN_MILLISECOND, GENERATE_TASK)) {
            ...
            log.info(String.format("Service \"%s\" start generate task", SERVICE_ID));
            ...
            log.info(String.format("Service \"%s\" stop generate task", SERVICE_ID));
            log.info(Strings.repeat("-",100));
